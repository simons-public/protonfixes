...
- Some games may treat the XBox and Steam Controller trigger axis as a 
- joystick input causing controls to drift upwards and to the left (this
- can be observed by running '/tmp/proton_$USER/run control' and looking
- at the Test Joystick tab under Game Controllers.
```
